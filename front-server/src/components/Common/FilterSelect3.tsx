...
import { CareerInfoDegree, genderInfoCode } from '../../atom'
...
const FilterSelect3 = ({ props, width, height, borderwidth, bordercolor, fontsize }: ComponentProps) => {
  const [careerInfoDegree, setCareerInfoDegree] = useRecoilState(genderInfoCode)
