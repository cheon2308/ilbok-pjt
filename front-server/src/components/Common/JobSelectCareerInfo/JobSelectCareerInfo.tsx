...
import { JobFamilyCode, JobFamilyCodeCareerInfo, JobFamilyName, JobFamilyNameCareerInfo } from '../../../atom'
...
function JobSelectCarrerInfo() {
  ...
  const [jobFamilyName, setjobFamilyName] = useRecoilState(JobFamilyNameCareerInfo) // 직업 대분류 이름
...
export default JobSelectCarrerInfo
